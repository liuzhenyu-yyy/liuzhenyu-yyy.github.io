...
<table style="font-size:16px;font-family:Arial;line-height:120%">
    ...
    <tr>
        ...
        <td><iframe style="border: 0px #ffffff none;" name="gscitations" src="https://author.my.id/widget/citations.php?id=wcQZmHIAAAAJ&lang=en" frameborder="0" marginwidth="0px" marginheight="0px" scrolling="no" width="400px" height="200px"></iframe></td>
    </tr>
    </tbody>
    <colgroup>
    <col>
